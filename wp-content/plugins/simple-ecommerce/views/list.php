                            ...
                            <tr id="post-<?php echo $product_id; ?> " class="author-self level-0 post-<?php echo $product_id; ?> type-product has-post-thumbnail">
                                ...
                                <td><?php
                                    ...
                                    ?>
                                            ...
                                            <a class="_simple_btn_get _simple_cursor" data-href="<?php echo LKN_BASE_PATH; ?>/simple-ecommerce-api.php?action=do_sync&product_id=<?php echo $product_id; ?>&return_to=<?php echo base64_encode($_SERVER['REQUEST_URI']) ?>">Sync
                                                This Product Now</a>
